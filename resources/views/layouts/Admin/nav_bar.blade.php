<menu class="fixed container menu" id="home">
  ...
  <div class="sidebar active" id="sidenav">
    ...
    <ul class="nav_list">
        ...
        <li><a href="/Roles"><i class="fas fa-user"></i><span class="links_name">Team Member Roles</span></a><span class="tooltip">Roles</span></li>
        <li><a href="/Courses"><i class="fas fa-laptop-file"></i><span class="links_name">My Courses</span></a><span class="tooltip">Courses</span></li>
    </ul>
  </div>
